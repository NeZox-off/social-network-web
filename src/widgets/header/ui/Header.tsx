...
export const Header = ({}: HeaderProps) => {
	return (
		<header className="sticky top-0 z-10 bg-white flex-1 flex justify-between border-b-2 border-b-zumthor-100 py-5 px-8">
			...
			<Button
				variant={'primary'}
				className="px-5 py-3 gap-3 rounded-full font-bold"
			>
